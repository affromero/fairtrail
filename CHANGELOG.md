...
- Local CLI and maintenance commands now use Infisical for injected secrets. Update local tooling credentials accordingly. ([`f30ba4f`](https://github.com/affromero/flight-finder/commit/f30ba4f))

### Known limitations

- The flight CLI's root `--json` invocation currently prints help before reaching its handler. Its JSON readers were tested directly; this release does not fix the entrypoint behavior introduced with the hotel commands. ([#209](https://github.com/affromero/flight-finder/pull/209), [#218](https://github.com/affromero/flight-finder/pull/218))
- `npm audit` still reports the MapLibre attribution sanitization advisory through Plotly's transitive MapLibre 4.7.1 dependency. Hotel maps use MapLibre 6.7.0, and flight charts use Cartesian scatter traces. The transitive dependency remains unresolved. ([GHSA-jrc7-96c5-q579](https://github.com/advisories/GHSA-jrc7-96c5-q579), [#217](https://github.com/affromero/flight-finder/pull/217))
