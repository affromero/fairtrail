...
import { captureDiscoverCarsProtection } from '../apps/web/src/lib/cars/discovercars-protection';
...
async function main() {
  ...
  try {
    ...
    await page.screenshot({ path: join(output, 'selected.png'), fullPage: true });
