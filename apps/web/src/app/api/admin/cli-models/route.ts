...
import { cliUpdateInfo } from '@/lib/scraper/cli-update';
...
export async function GET(request: Request) {
  ...
  try { return apiSuccess({ ...await discoverCliModels(provider, url.searchParams.get('refresh') === 'true'), ...cliUpdateInfo(provider) }); }
